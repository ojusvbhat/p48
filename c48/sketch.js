...
function preload(){
  ...
  MonsterImg = loadImage("assets/download.png");
  clownImg = loadImage("assets/download-1.png");
  vampireImg = loadImage("assets/download-2.png");
...
Monster = createSprite(windowWidth-100,500,30,30);
Monster.addImage("m",MonsterImg);

clown = createSprite(1150,300,30,30);
clown.addImage("c",clownImg);
clown.scale =0.5;

vampire = createSprite(315,240,30,30);
vampire.addImage("v",vampireImg);
vampire.scale=0.4;
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(500,1100),random(400,900),40,40)
